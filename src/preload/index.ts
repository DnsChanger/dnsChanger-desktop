...
export const ipcPreload = {
  ...
  addDns: (data: Partial<Server>) => ipcRenderer.invoke(EventsKeys.ADD_DNS, data),
...
export const uiPreload = {
  toggleTheme: (newTheme: string) => ipcRenderer.invoke(EventsKeys.TOGGLE_THEME, newTheme)
}

export const osItems = {
  os: os.platform(),
  getInterfaces: () => ipcRenderer.invoke(EventsKeys.GET_NETWORK_INTERFACE_LIST)
}
