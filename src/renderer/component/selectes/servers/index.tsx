...
export function ServersListSelectComponent() {
  ...
  const selectedDef = serversStateContext.selected?.key == 'unknown' || !serversStateContext.selected
  ...
  return (
    <Select
      className={'w-[360px] dark:bg-[#262626] bg-base-200 text-[#6B6A6A] border-none rounded-[23px]'}
      borderOffset={true}
